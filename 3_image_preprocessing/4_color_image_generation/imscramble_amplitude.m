% function imScrambled = imscramble_amplitude(im,p,rescale)
% 
...
function imScrambled = imscramble_amplitude(im,rescale)
...
Random_amplitude = abs(fft2(rand(imSize(1), imSize(2))));
Random_amplitude(1) = 0; % leave out the DC value
% Random_amplitude = 250;
