...
parser.add_argument('--data',default='data/all_datasets/feature_images/texture', help='path to dataset')
# parser.add_argument('-a', '--arch', metavar='ARCH', default='data/iLab/model/ori_resnet18/')
parser.add_argument('-a', '--arch', metavar='ARCH', default='data/all_datasets/model/texture_resnet18/')
