...
parser.add_argument('--data',default='data/all_datasets/original_images', help='path to dataset')
# parser.add_argument('-a', '--arch', metavar='ARCH', default='data/iLab/model/ori_resnet18/')
parser.add_argument('-a', '--arch', metavar='ARCH', default='data/all_datasets/model/original_resnet18/')
